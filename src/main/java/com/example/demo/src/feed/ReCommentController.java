...
import com.example.demo.src.feed.model.feedComment.FeedCommentUpdateRequestDto;
...
public class ReCommentController {
    ...
    public BaseResponse<ReCommentRes> createComment(@PathVariable Long commentId,
        ...
        ReCommentRes reCommentRes = reCommentService.createReComment(commentId,reCommentDto);
